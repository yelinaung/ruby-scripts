...
get '/' do
  ...
  @agd_json= Currencies.new(Nokogiri::HTML(open(@sources[:agd])),"AGD").to_hash_AGD
  @cb_json=  Currencies.new(Nokogiri::HTML(open(@sources[:cb])),"CB").to_hash_CB
  @kbz_json=  Currencies.new(Nokogiri::HTML(open(@sources[:kbz])),"KBZ").to_hash_KBZ
